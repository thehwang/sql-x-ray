...
def _mermaid_js() -> str:
    ...
    path = resources.files("sqlucent") / "vendor" / "mermaid.min.js"
...
_LABELS = {
    "en": {
        ...
        "footer": "Generated by SQLucent &middot; data-flow via Mermaid",
        "statement": "Statement",
    ...
    "zh": {
        ...
        "footer": "由 SQLucent 生成 &middot; 数据流图基于 Mermaid",
        "statement": "语句",
